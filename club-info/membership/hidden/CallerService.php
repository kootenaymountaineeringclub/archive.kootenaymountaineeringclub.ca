...
Called by startPayment.php, getExpressCheckoutDetails.php, 
...
function hash_call($methodName,$nvpStr)
{
	...
	// Get the PayPay Credential from database
	debug_log("In hash_call");
	db_connect();
	$sql = "SELECT pp1, pp2, pp3 FROM MemberConfig WHERE Id = 1";
	$row = db_select_single_row($sql);
	$API_UserName = $row['pp1'];
	$API_Password = $row['pp2'];
	$API_Signature = $row['pp3'];
	$API_Endpoint = 'https://api-3t.paypal.com/nvp';
	debug_log("hash_call: PayPal credentials built");
