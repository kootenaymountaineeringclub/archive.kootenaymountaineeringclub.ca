<?php
	...
	*/
	function CallShortcutExpressCheckout( $paramsArray, $returnURL, $cancelURL) 
	{
		...
		if(isset($paramsArray["PAYMENTREQUEST_0_DESC"])) {
			$nvpstr .= "&PAYMENTREQUEST_0_DESC=" . $paramsArray["PAYMENTREQUEST_0_DESC"];
			// $nvpstr .= "&L_PAYMENTREQUEST_0_DESC0=" . $paramsArray["PAYMENTREQUEST_0_DESC"];
		}
		...
		if(isset($paramsArray["SOLUTIONTYPE"]))
		{
			$nvpstr = $nvpstr . "&SOLUTIONTYPE=" .  $paramsArray["SOLUTIONTYPE"];
			$_SESSION["PaymentType"] = $paramsArray["paymentType"];
		}
