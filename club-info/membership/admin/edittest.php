...
<div id="master">
	...
	<section>
			...
			<form method="post" action="php/edit_membership.php">
		...
		$sql = "select TransactionID, MembershipID, Year, MembershipType, FirstName, NickName, LastName, DistinctName, StreetAddress, StreetAddress2, City, Province, PostalCode, Country, Email, Phone, KmcNewsletter, FmcbcNewsletter, PrivateName, Inserted from Member where MembershipID = " . $_POST["numb"];
		...
		if ($count == 1) {
			...
			<div class="formPart<?php if ($count == 1) { ?> formHidden" id="name2">
				<p class="formHeader">Name 2:</p>
				<div class="formItem">
					<label class="required" for="FirstName2">First name : </label>
					<label class="required" for="FirstName2">First name : </label><input class="text" type="text" id="FirstName2" name="FirstName2"><br>
					<label for="NickName2">Initial or nickname? : </label><input class="text"  type="text" name="NickName2"><br>
					<label class="required" for="LastName2">Last name : </label><input class="text" type="text" id="LastName2" name="LastName2"><br>
					<label for="SharedEmail">Shared Email : </label><input type="checkbox" id="SharedEmail" name="SharedEmail" value="1"> or ...<br>
					<label for="Email2">Email address : </label><input class="text" type="email"  name="Email2"><br>
					<label for="Phone2">Phone : </label><input class="text"  type="text" name="Phone2"><br>
			...
			<div class="formPart" id="address">
				...
				<div class="formItem">
					...
					<label id="LabelProv" for="Prov">Province/State : </label>
					<input class="text" type="text" id="Prov" name="Prov" value="<?php echo $name1['Province']?>"><br>
					<label id="LabelPostCode" for="PostCode">Postal code/Zip : </label>
					<input class="text"  type="text" id="Postal" name="Postal" value="<?php echo $name1['PostalCode']?>"><br>
				</div>
			</div>
