<?php
	...
	$url = 'https://' . $serverName . '/club-info/documents/executive-files/' ;
	...
	$member_file = $WorkingPath . "club-info/documents/executive-files/members.csv";
	$fp_members = fopen( $member_file , "w");
	
	$contact_file = $WorkingPath . "club-info/documents/executive-files/contacts.csv";
	$fp_contacts = fopen( $contact_file, "w");
	
	$kmc_paper = $WorkingPath . "club-info/documents/executive-files/kmc_paper.csv";
	$fp_kmc_paper = fopen( $kmc_paper, "w");
	
	$kmc_electronic = $WorkingPath . "club-info/documents/executive-files/kmc_electronic.csv";
	$fp_kmc_electronic = fopen( $kmc_electronic, "w");
	
	$fmcbc_paper = $WorkingPath . "club-info/documents/executive-files/fmcbc_paper.csv";
	$fp_fmcbc_paper = fopen( $fmcbc_paper, "w");
	
	$fmcbc_electronic = $WorkingPath . "club-info/documents/executive-files/fmcbc_electronic.csv";
	$fp_fmcbc_electronic = fopen( $fmcbc_electronic, "w");
	
	$listsrv = $WorkingPath . "club-info/documents/executive-files/lstsrv.txt";
	$fp_lstsrv = fopen( $listsrv, "w");
	
	$emails = $WorkingPath . "club-info/documents/executive-files/emailaddr.txt";
	$fp_emails = fopen( $emails, "w");
	...
	$sql = "SELECT * FROM kmcweb_0_kmc.Member WHERE " . $YearSelect . " ORDER BY LastName, FirstName";
