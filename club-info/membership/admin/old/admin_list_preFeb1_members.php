...
<head>
	...
	<title>Membership Admin: Members Who Renewed Pre Feb. 1 List</title>
	...
	<?php include ("../includes/club-membership.incl.html") ; ?>
		...
		<section>
			...
			<?php
				...
				echo "<p>2016 KMC Members pre February 1st : " . $when . "</p>\n";
				echo "<pre>\n";
				
				$sql = "SELECT DistinctName,Email FROM kmcweb_0_kmc.Member where Inserted < date('2016-02-01') ORDER BY DistinctName";
				...
				echo "</table>\n</pre>";
				echo "<p>" . $count . " members joined or renewed before February 1st.</p>";
