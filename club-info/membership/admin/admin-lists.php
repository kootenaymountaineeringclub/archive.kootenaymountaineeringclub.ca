<?php
	...
	$hdg_members = "Last Name, First Name, Active, MembershipType, Street Address, Mailing Address, City, Province, Postal Code, Country, Email, Phone, Kmc Newsletter, PMCBC Newsletter, Private Name, Private City, Private Email, Private Phone, Voting, Child, Amount, Payment Type, Payment Status, Enrollment Type, Year, ID, Parent ID\n";
...
<div id="master">
	...
	<div id="content">
		...
		<section>
			...
			List files are located on the web server at our web directory /club-info/documents/executive-files/.</p>
			<hr>
