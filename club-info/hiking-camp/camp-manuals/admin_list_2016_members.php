...
<head>
	...
	<title>Membership Admin: 2016 Members List</title>
	...
	<?php include ("../includes/club-membership.incl.html") ; ?>
		...
		<section>
			...
			<?php
				...
				echo "<p>Already 2016 KMC Members : " . $when . "</p>\n";
				echo "<pre>\n";
				
				$sql = "SELECT DistinctName,Email FROM kmcweb_0_kmc.Member ORDER BY DistinctName";
				...
				echo "</table>\n</pre>";
				echo "<p>" . $count . " members who are 2016 members.</p>";
