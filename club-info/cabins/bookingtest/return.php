    ...
    <?php
	    	...
	    	if ( $_SESSION['bookerEmail'] != "" ) {
				...
				$tosend = "Bonnington Cabin Booking\n\n" .
					...
					$tosend .= "Thank you. PayPal should also send you a receipt.\nFor questions, etc. please send email to cabins@kootenaymountaineeringclub.ca";
	  		...
	  		$cabinsend = "Cabin booking by: " . $address . "\n\n" . $cabinsend;
				mail('cabins@kootenaymountaineeringclub.ca','Bonninton Cabin Booking Test',$cabin;send);
