...
if($_POST) //Post Data received from product list page.
{
    ...
    $ItemName       = "KMC Bonnington Cabin Booking"; //Item Name
    $ItemPrice      = 30; //Item Price
    $ItemNumber     = session_id(); //Item Number
    $ItemDesc       = "Grassy cabin and Steed cabin"; //Item description
...
*/    
    ...
    $padata =   '&METHOD=SetExpressCheckout'.
                ...
                */
                ...
                '&LOCALECODE=CA'. //PayPal pages to match the language on your website.
                '&LOGOIMG=https://kootenaymountaineeringclub.ca/images/GimliLogoSmall.png'. //site logo
